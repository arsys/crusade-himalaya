...
{{-- <div class="uk-section uk-section-small uk-section-default">
	<div class="uk-container uk-container-expand">
		...
		<div class="uk-card uk-card-default uk-card-body uk-margin-remove">
		    <ul class="uk-child-width-expand uk-tab" data-uk-tab="{connect:'#my-id'}">
		        <li class="uk-active"><a href="#justify">Why Nepal?</a></li>	     
		        <li  class="over"><a href="#item1">Why Crusade Himalaya?</a></li>
		        <li><a href="#item2">How we work?</a></li>
		        <li><a href="#item3">What makes Crusade Himalaya different?</a></li>
	         	<li><a href="#item4">What is our mission?</a></li>
		    </ul>
...
<div class="uk-card uk-card-default uk-visible@l" id="team-wrapper">	
	<div class="uk-panel "   uk-sticky="offset:80" >
		<ul uk-scrollspy-nav="closest: li; scroll: true; offset: 190" class="uk-nav uk-nav-default uk-nav-center tm-nav uk-nav-parent-icon  uk-flex  uk-flex-row text-color" uk-nav>
		        ...
		        <li class="uk-width-1-5"><a href="#item3">What makes Crusade Himalaya different?</a></li>
	         	<li class="uk-width-1-5"><a href="#item4">What is our mission?</a></li>
		</ul>
	</div>	
</div>
<section class="uk-container uk-margin-small-top uk-margin-large-bottom  uk-visible@l" id="content-wrapper">
	<div class="uk-grid-small uk-grid-match uk-child-width-expand uk-grid" uk-grid="">
		<div>
			...
			<div class="uk-card uk-card-body uk-card-default uk-margin-small-bottom " id="item1">
			<h3 class="over"><span>Why Crusade Himalaya?</span></h3>
				<p>Crusade Himalaya is a unique and independent travel partner; we are a boutique travel studio who wish to offer you, our Atithis (revered guests), enriching and fulfilling experience of their Nepal visit. We wish to Empower, Educate, and Encourage you to have real-life experiences as you set out to discover the timeless wonders of Nepal.</p> 
			</div>
			<!-- Why Crusade Himalaya? end -->
			<!-- How we work start	 -->
			<div class="uk-card uk-card-body uk-card-default uk-margin-small-top " id="item2">
			...
			<div class="uk-card uk-card-body uk-card-default uk-margin-small-top" id="item4">
				<h3 class=""><span>What is our mission?</span></h3> 
				<p>Our mission is simple, it is <strong>to make you happy</strong>. To do so, we will take you across many of the delights Nepal has to offer, introduce you to different cultures, and all the while ensuring your comfort and satisfaction.</p>
