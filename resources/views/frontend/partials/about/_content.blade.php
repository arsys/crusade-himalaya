	...
	<div class="uk-container">
		<div class="text-align-left uk-margin-medium-top" uk-grid>
			<div class=" uk-flex uk-flex-column uk-width-1-3@l uk-width-1-1@s" >
				<div>
					<p class="heading-wrapper uk-padding-remove"><strong>Why Nepal?</strong></p>
				...
				<div>
					<p class="heading-wrapper uk-padding-remove"><strong>Why Crusade Himalaya?</strong></p>
				...
				<div>
					<p class="heading-wrapper uk-padding-remove"><strong>How we work?</strong></p>
			...
			<div class=" uk-flex uk-flex-column uk-width-1-3@l uk-width-1-1@s" >
				...
				<div>
					...
					<p>&nbsp;</p>
					<p class="heading-wrapper  uk-padding-remove"><strong>What makes Crusade Himalaya different?</strong></p>
			...
			<div class=" uk-flex uk-flex-column uk-width-1-3@l uk-width-1-1@s" >
				<div>
				<p class="heading-wrapper  uk-padding-remove"><strong>What is our mission?</strong></p>
