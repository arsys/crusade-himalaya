                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            {{ Form::text('name', Request::old('name'), ['class' => 'form-control',  'required']) }}
                            @if($errors->has('name'))
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group  {{$errors->has('position') ? 'has-error' : ''}}">
                            {{ Form::text('position', Request::old('position'), ['class' => 'form-control',  'required']) }}
